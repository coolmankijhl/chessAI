...
int main() {
    ...
    Board mainBoard = {{{2, 'R', true},{2, 'N'},{2, 'B'},{2, 'Q'},{2, 'K', true},{2, 'B'},{2, 'N'},{2, 'R', true}}, 
         ...
         Board testBoard = {{{0, '_'},{0, '_'},{1, 'P'},{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'}},
                             {{0, '_'},{0, '_'},{1, 'P'},{1, 'P'},{0, '_'},{0, '_'},{0, '_'},{0, '_'}},
                             {{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'},{2, 'P'}},
                             {{0, '_'},{0, '_'},{0, '_'},{1, 'P'},{0, '_'},{0, '_'},{0, '_'},{0, '_'}},
                             {{0, '_'},{0, '_'},{1, 'P'},{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'}},
                             {{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'}},
                             {{0, '_'},{0, '_'},{1, 'P'},{0, '_'},{0, '_'},{0, '_'},{0, '_'},{0, '_'}},
